...
**Spec/documentation files** are **NOT** affected — they remain lowercase kebab-case with numeric prefixes (e.g., `01-architecture.md`). See File Naming Convention <!-- external: spec/00-spec-authoring-guide/02-naming-conventions.md -->.
