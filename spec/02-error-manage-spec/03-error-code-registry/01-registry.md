...
- Cast errors must **never** be swallowed — see §7.2 and §10 in [03-casting-elimination-patterns.md](../../01-coding-guidelines/03-coding-guidelines-spec/01-cross-language/03-casting-elimination-patterns.md)
